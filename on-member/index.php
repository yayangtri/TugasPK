...
<body data-spy="scroll" data-target="#navbarResponsive">
    ...
    <div class="row jumbotron welcome">
        ...
        <div class="col-xs-12 col-sm-12 col-md-9 col-lg-9 col-xl-10">
            <p class="lead">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aliquid corporis, praesentium. Dolorum ut placeat mollitia delectus, optio sit autem voluptas alias, molestiae nobis totam asperiores excepturi fugiat dignissimos tempore quibusdam.</p>
        </div>
        <!-- </div> -->
        ...
        <div class="container-fluid padding alat">
            <div class="row text-center padding">
                <div class="col-xs-12 col-sm-6 col-md-4">
                    <div class="card">
                        <img src="../assets/img/bg/images.jpeg" class="card-img-top">
                        <div class="card-body">
                            <div class="mb-3">
                                <div class="font-weight-bold">Jam Tangan</div>
                ...
                <div class="col-xs-12 col-sm-6 col-md-4 thumbnail">
                    <div class="card">
                        <img src="../assets/img/bg/images2.jpeg" class="card-img-top">
                        <div class="card-body">
                            <div class="mb-3">
                                <div class="font-weight-bold">Jam tangan</div>
                ...
                <div class="col-xs-12 col-sm-6 col-md-4 thumbnail">
                    <div class="card">
                        <img src="../assets/img/bg/images3.jpeg" class="card-img-top">
                        <div class="card-body">
                            <div class="mb-3">
                                <div class="font-weight-bold">Jam tangan</div>
                    ...
                    <div class="row">
                        <div class="col-md-6 development">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <img src="../foto_profil/admin.jpg" alt="">
                                </div>
                                <div class="col-md-6">
                                    <blockquote>
            ...
            <div class="container mt-5">
                ...
                <div class="row">
                    <div class="col-md-12 text-center mt-2">
                        <p>
                            &copy;Copyright with Bootstrap 4 theme 2019 design by <i class="fa fa-heart-broken"></i>
